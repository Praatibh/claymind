...
export default function HeroSection() {
  ...
  // State for draggable windows - positions calculated based on viewport
    ...
    return [
      {
        ...
        isActive: true,
        x: Math.min(viewportWidth * 0.55, 750),
        y: 120,
        width: 420,
        type: "face",
        dotColor: "bg-[#000000]",
      ...
      },
      {
        ...
        isActive: false,
        x: Math.min(viewportWidth * 0.5, 680),
        y: 380,
        width: 320,
        type: "media",
        dotColor: "bg-[#39E17F]",
  ...
  return (
    <section className="relative min-h-[100vh] w-full overflow-hidden bg-[#F1EEE9] pt-[120px] pb-[120px]">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          ...
          className="object-cover opacity-100 absolute inset-0 w-full h-full"
        />
      ...
      {/* Mobile-only static preview of windows - show all windows */}
