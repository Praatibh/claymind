...
import DitheredShape from '../ui/dithered-shape';
                ...
                <div className="p-3">
                  ...
                  <nav className="space-y-1">
                    {PALS_DATA.map((pal) => (
                      ...
                      >
                        <div className="relative w-10 h-10 border border-black flex-shrink-0 overflow-hidden">
                          <img
                            src={pal.avatar}
                            alt={pal.name}
                    ...
                    <div className="col-span-full border-b border-black pb-2 flex items-baseline gap-10">
                      ...
                      <div className="space-y-4">
                        ...
                        {'featuredImage' in activePal && activePal.featuredImage && (
                          <div className="relative w-full aspect-video border border-black mt-4 shadow-brutal-sm overflow-hidden">
                            <img
