            ...
            <div className="p-6 bg-[#F7F4EF] pointer-events-none select-none">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="w-12 h-12 border border-black/10 grayscale">
                  <Image src={assets.eyeIcon} alt="" width={48} height={48} className="object-cover" />
                </div>
              </div>
          ...
          >
            ...
            <div className="p-6 bg-[#F7F4EF] pointer-events-none select-none">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="w-12 h-12 border border-black/10 grayscale">
                   <Image src={assets.codeIcon} alt="" width={48} height={48} className="object-cover" />
                </div>
              </div>
              <p className="text-sm mb-6 leading-relaxed">
          ...
          >
            ...
            <div className="p-6 bg-[#F7F4EF] pointer-events-none select-none">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="w-12 h-12 border border-black/10 grayscale">
                  <Image src={assets.lipsIcon} alt="" width={48} height={48} className="object-cover" />
                </div>
              </div>
              <p className="text-sm mb-6 leading-relaxed">
